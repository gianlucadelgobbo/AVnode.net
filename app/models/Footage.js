...
const footageSchema = new Schema({
  old_id: String,
  createdAt: Date,
  title: { type: String, trim: true, required: [true, 'FOOTAGE_TITLE_IS_REQUIRED'], minlength: [3, 'FOOTAGE_TITLE_IS_TOO_SHORT'], maxlength: [100, 'FOOTAGE_TITLE_IS_TOO_LONG'] },
  slug: { type: String, unique: true, trim: true, required: [true, 'FOOTAGE_URL_IS_REQUIRED'], minlength: [3, 'FOOTAGE_URL_IS_TOO_SHORT'], maxlength: [100, 'FOOTAGE_URL_IS_TOO_LONG'],
    validate: [(slug) => {
      var re = /^[a-z0-9-_]+$/;
      return re.test(slug)
    }, 'FOOTAGE_URL_IS_NOT_VALID']
  },
