...
footageSchema.virtual('imageFormats').get(function () {
  ...
  if (this.media && this.media.preview) {
    ...
    const localPath = serverPath.substring(0, serverPath.lastIndexOf('/')).replace('/glacier/footage_previews/', process.env.WAREHOUSE+'/warehouse/footage_previews/'); // /warehouse/2017/03
