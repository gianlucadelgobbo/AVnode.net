...
const programSchema = new Schema({
  ...
  schedule: [Schedule],
  performance: { type: Schema.ObjectId, ref: 'EventFreezedPerformance', required: true },
...
},
{
  id: false,
  timestamps: true,
  collection: 'event_freezed_program',
  toObject: {
    virtuals: true
  },
  toJSON: {
...
const EventFreezedProgram = mongoose.model('EventFreezedProgram', programSchema);

export default EventFreezedProgram;
