        ...
        if (error) {
          ...
          try {
            ...
            if (json.results.length) {
              ...
              addressesA[index].formatted_address = json.status;
            }
    ...
    exec((err, data) => {
      ...
      for (const item in data) {
        for (const address in data[item].addresses) {
          ...
          if (locality=='Rome') locality = 'Roma';
          if (locality=='Milan') locality = 'Milano';
          if (locality=='Milani') locality = 'Milano';
          if (locality=='Newyok') locality = 'New York';
          if (locality=='New York City') locality = 'New York';
          if (locality=='New York, Ny') locality = 'New York';
          if (locality=='New York,') locality = 'New York';
          if (locality=='New York, Ny 10025') locality = 'New York';
          if (locality=='New York, Ny 10003') locality = 'New York';
          if (locality=='Moscow Region') locality = 'Moscow';
          if (locality=='Moscow ') locality = 'Moscow';
          if (locality=='México City ') locality = 'Mexico City';
          if (locality=='Mexico') locality = 'Mexico City';
          if (locality=='Mexico D.f.') locality = 'Mexico City';
          if (locality=='Mexico, Df') locality = 'Mexico City';
          if (locality=='Cdmx') locality = 'Mexico City';
          if (locality=='C.d.m,x') locality = 'Mexico City';
          if (locality=='Df') locality = 'Mexico City';
          if (locality=='Emxico') locality = 'Mexico City';
          if (locality=='México') locality = 'Mexico City';
          if (locality=='México D.f ') locality = 'Mexico City';
          if (locality=='México D.f') locality = 'Mexico City';
          if (locality=='Mexico Df') locality = 'Mexico City';
          if (locality=='Mex') locality = 'Mexico City';
          if (locality=='Mx') locality = 'Mexico City';
          if (locality=='Ciudad De México') locality = 'Mexico City';
          if (locality=='Cd. De México') locality = 'Mexico City';
          if (locality=='Distrito Federal') locality = 'Mexico City';
          if (locality=='D.f') locality = 'Mexico City';
          if (locality=='D.f.') locality = 'Mexico City';
          if (locality=='México City') locality = 'Mexico City';
          if (locality=='México Df') locality = 'Mexico City';
          if (locality=='Ciudad De Mex') locality = 'Mexico City';
          if (locality=='Ciudad De Mxico') locality = 'Mexico City';
          if (locality=='Mexico Distrito Federal') locality = 'Mexico City';
          if (locality=='Mexico   City') locality = 'Mexico City';
          if (locality=='Mecico City') locality = 'Mexico City';
          if (locality=='Mexicodf') locality = 'Mexico City';
          if (locality=='México D.f.') locality = 'Mexico City';
          if (locality=='México, Df') locality = 'Mexico City';
          if (locality=='México.') locality = 'Mexico City';
          if (locality=='Xalapa,ver') locality = 'Xalapa';
          if (locality=='Xalapa,ver.') locality = 'Xalapa';
          if (locality=='Xalapa, Ver.') locality = 'Xalapa';
          if (locality=='Xalapa, Ver') locality = 'Xalapa';
          if (locality=='San Paolo') locality = 'Sao Paolo';
          if (country == 'Hong Kong' && locality && locality.toLowerCase()=='hk') locality = 'Hong Kong';
          if (country == 'Hong Kong' && locality && locality.toLowerCase()=='hongkong') locality = 'Hong Kong';
