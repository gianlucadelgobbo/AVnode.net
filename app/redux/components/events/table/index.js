        ...
        columns={[
          {
            ...
            Cell: props => {
              ...
              return (
                <div>
                  <div><b><Link to={`/admin/events/${original._id}/public`}> <i className="fa fa-edit" /> </Link> | <Link onClick={this.forceUpdate} to={`/events/${original.slug}/`}> <i className="fa fa-eye" /> </Link> | {original.title}</b></div>
