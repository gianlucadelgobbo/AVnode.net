...
const items = [
  {
    ...
    label: (
      <FormattedMessage id="publicDataEvents" defaultMessage="Public data" />
    )
  },
  {
    href: "/admin/events/:_id/images",
    label: <FormattedMessage id="imagesEvents" defaultMessage="Image" />
  },
  /*  {
    ...
    */
  {
    ...
    label: <FormattedMessage id="galleriesEvents" defaultMessage="Galleries" />
  },
  {
    href: "/admin/events/:_id/videos",
    label: <FormattedMessage id="videosEvents" defaultMessage="Videos" />
  },
  /* {
    ...
    }, */
  {
    ...
    label: <FormattedMessage id="settingEvents" defaultMessage="Settings" />
  }
];
