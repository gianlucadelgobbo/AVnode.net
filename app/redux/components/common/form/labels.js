...
//Profile Emails
export const EMAILS = "label.form.emails";
export const SUBSCRIPTIONS = "label.form.subscriptions";
//Profile Private
export const NAME = "label.form.name";
export const SURNAME = "label.form.surname";
export const GENDER = "label.form.gender";
...
export const EVENT_DESCRIPTION = "event.label.form.event.calls.description";
...
export const CATEGORY_VJTV_NO_EXTERNAL = "label.form.category_vjtv_no_external";
//Table
