        ...
        columns={[
          {
            ...
            Cell: props => {
              ...
              return (
                <div>
                  <div><b><Link to={`/admin/performances/${original._id}/public`}> <i className="fa fa-edit" /> </Link> | <Link onClick={this.forceUpdate} to={`/performances/${original.slug}/`}> <i className="fa fa-eye" /> </Link> | {original.title}</b></div>
