...
export const getIds = state => state[entity].list.ids;

export const getIsFetching = state => state[entity].list.isFetching;

export const getErrorMessage = state => state[entity].list.errorMessage;

export const getList = state =>
  state[entity].list.ids &&
  state[entity].list.ids.map(id => getModel(state, id));

export const getModel = (state, id) => state[entity].byId[id];
