        ...
        columns={[
          {
            ...
            Cell: props => {
              ...
              return (
                <div>
                  <div><b><Link to={`/admin/crews/${original._id}/public`}> <i className="fa fa-edit" /> </Link> | <Link onClick={this.forceUpdate} to={`/${original.slug}/`}> <i className="fa fa-eye" /> </Link> | {original.stagename}</b></div>
