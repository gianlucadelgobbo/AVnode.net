...
export const saveEventCalls = model => {
  return axios.post(`events/${model._id}/calls`, model).then(result => {
    return result.data;
  });
};
...
export const saveEventSettings = model => {
  return axios.post(`events/${model._id}/settings`, model).then(result => {
    return result.data;
  });
};
...
export const postPerformance = obj => {
  return axios.post(`performances/`, obj).then(result => {
    return result.data;
  });
};
...
export const savePerformanceImages = model => {
  return axios.post(`performances/${model._id}/image`, model).then(result => {
    return result.data;
  });
};
...
export const savePerformanceVideos = model => {
  return axios.post(`performances/${model._id}/videos`, model).then(result => {
    return result.data;
  });
};
...
export const postFootage = obj => {
  return axios.post(`footage/`, obj).then(result => {
    return result.data;
  });
};
...
export const savePerformanceUsers = model => {
  return axios.post(`performances/${model._id}/users`, model).then(result => {
    return result.data;
  });
};
...
export const postCrew = obj => {
  return axios.post(`crews/`, obj).then(result => {
    return result.data;
  });
};
...
export const saveCrewMembers = model => {
  return axios.post(`crews/${model._id}/members`, model).then(result => {
    return result.data;
  });
};
...
export const saveSignupPublic = model => {
  return axios.post(`signup`, model).then(result => {
    return result.data;
  });
};
