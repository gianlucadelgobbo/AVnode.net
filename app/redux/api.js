...
export const saveEventCalls = model => axios.post(`events/${model._id}/calls`, model)
...
export const saveEventSettings = model => axios.post(`events/${model._id}/settings`, model)
...
export const savePerformanceImages = model => axios.post(`performances/${model._id}/image`, model)
...
export const savePerformanceVideos = model => axios.post(`performances/${model._id}/videos`, model)
...
export const savePerformanceUsers = model => (`performances/${model._id}/users`, model)
...
export const saveCrewMembers = model => axios.post(`crews/${model._id}/members`, model)
