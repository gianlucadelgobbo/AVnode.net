...
router.put('/crew/:id/member/:memberId', (req, res) => {
  console.log('router.put /crew/:id/member/:memberId ' + JSON.stringify(req.params));
  User
    ...
    .exec((err, user) => {
      ...
      console.log('router.put /crew/:id/member/:memberId user:' + JSON.stringify(user));
      // sometimes reindex elasticsearch if user does not exist in mongodb anymore
      if (user) {
        if (user.crews) user.crews.push(req.params.id);
        user.save((_err) => {
          if (_err) {
...
router.get('/languages', (req, res) => { 
  res.json(allLanguages.getLanguageCodes());
});
