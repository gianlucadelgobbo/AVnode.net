...
const fetchUser = (id, cb) => {
  User
    ...
    .populate([{
      ...
      path: 'crews',
      select: { 'slug': 1, 'stagename': 1, 'username': 1, 'about': 1, 'aboutlanguage': 1, 'abouts': 1, 'image': 1, 'teaserImage': 1, 'file': 1 },
      model: 'User',
      populate: [{
        path: 'image',
        model: 'Asset'
...
router.put('/user/:id', (req, res) => {
  ...
  logger.debug(`${apiCall} req.body.postal_code: ${req.body.postal_code}`);
