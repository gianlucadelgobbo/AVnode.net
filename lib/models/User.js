...
const userSchema = new Schema({
  ...
  name: String,
  surname: String,
  about: String, // BL TODO frontend, issue #5, added multilang needed
  citizenship: [], // BL TODO frontend, issue #5, modifyed, was a string
  addresses: [], // BL TODO frontend, issue #5, added, needs a address schema addresses: [address]
  roles: [], // BL TODO frontend, issue #5, added, array of roles?
  activity: Number, // BL TODO frontend, issue #5, added
  language: String, // BL TODO frontend, issue #5, added
