...
const userSchema = new Schema({
  ...
  // BL useless addresses: [{ type : Schema.ObjectId, ref : 'Address' }], // BL TODO frontend, issue #5
  address: String, // BL gmap response formatted_address
  ...
  name: String,
  surname: String,
  about: String, // BL TODO frontend, issue #5, multilang needed
