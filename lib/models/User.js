...
const userSchema = new Schema({
  ...
  about: String, // BL for the frontend, issue #5, english default
  aboutlanguage: String, // BL for the frontend, issue #5, about default language
  abouts: [About], // BL issue #5, multilang needed
...
userSchema.pre('save', function save(next) {
  ...
  console.log('userSchema.pre(save) user.abouts:' +  JSON.stringify(user.abouts) );
