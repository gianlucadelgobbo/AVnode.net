	...
	// Cross-populate minimum/maximum times for a range
 	return {minDatetime: (input.id === 'timeTo' ?
		...
		/** Default settings for the plugin.
			...
			@property [spinnerImage='/datetimeentry/spinnerDefault.png'] {string} The URL of the images to use for the date spinner -
		...
		defaultOptions: {
			...
			maxTime: null,
			timeSteps: [1, 1, 1],
			spinnerImage: '/datetimeentry/spinnerDefault.png',
			spinnerSize: [20, 20, 8],
			spinnerBigImage: '',
