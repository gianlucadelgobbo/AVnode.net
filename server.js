...
const allowedOrigins = [
  ...
  "http://avnode.local",
  "http://by.avnode.local",
  "http://de.avnode.local",
  "http://es.avnode.local",
  "http://fr.avnode.local",
  "http://gr.avnode.local",
  "http://hu.avnode.local",
  "http://it.avnode.local",
  "http://pl.avnode.local",
  "http://pt.avnode.local",
  "http://ru.avnode.local",
